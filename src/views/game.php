...
?><div class="game" data-tick="<?=$game->getTick()?>"><?php
	?><div class="gameHeader"><?php
		?><ul class="gameControls"><?php
			?><li><a class="previousTick"<?php if($game->getTick() > 1){ ?> href="<?=$this->getPreviousUrl()?>"<?php } ?> rel="nofollow">Previous<i> tick</i></a></li><?php
			?><li><a class="nextTick" href="<?=$this->getNextUrl()?>" rel="nofollow">Next<i> tick</i></a></li><?php
